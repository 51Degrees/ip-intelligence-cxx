...
#include "../examples/C/IpIntelligence/ReloadFromMemory.c"

class ExampleTestReloadFromMemory : public ExampleIpIntelligenceTest {
public:
...
EXAMPLE_TESTS(ExampleTestReloadFromMemory)