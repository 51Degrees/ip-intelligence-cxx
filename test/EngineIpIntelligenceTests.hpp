...
ENGINE_PROPERTIES_STRING(AllEdgePropertyStrings, "RegisteredName,RegisteredOwner,AccuracyRadiusMin")
...
ENGINE_PROPERTIES_ARRAY_THREE(AllEdgePropertyArray, "RegisteredName", "RegisteredOwner", "AccuracyRadiusMin")
