...
#ifndef FIFTYONE_DEGREES_IP_INTELLIGENCE_CONSTANTS_HPP
#define FIFTYONE_DEGREES_IP_INTELLIGENCE_CONSTANTS_HPP
...
const static char _ipAddressesFileName[] = "evidence.csv";
